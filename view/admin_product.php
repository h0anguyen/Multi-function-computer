            ...
            <section class="main">
                ...
                <div class="body_main">
                    <div class="sp">
                        ...
                        <a href="../view/admin_form_add_product.php" class="button_add"><button>Thêm sản
                                phẩm</button></a>
                    </div>
                    <div class="search">
                        <form action="../controller/admin_controller.php?action=seach" method="post">
                    ...
                    <table class="table_one">
                        ...
                        <tbody style="font-size: small;">
                            ...
                            $lgc = $ProductDB->Get_Product_To_Category_A($categoryId);
