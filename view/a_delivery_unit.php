            ...
            <section class="main">
                ...
                <div class="body_main">
                    <div class="sp" id="sp">
                        ...
                        <h2 class="namett" id="choose"><a href="../view/a_delivery_unit.php">Đơn hàng cần giao</a>
                        </h2>

                        <h2 class="orderall"><a href="../view/a_deliver_unit_all.php">Tất cả đơn hàng</a></h2>
                    ...
                    <div>
                        <table class="table_order">
                            ...
                            <tbody>
                                ...
                                if ($seach_p == null) {
                                    $list_o = $OrdersDB->Delivery_Order();
